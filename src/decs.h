...
#if defined(SPARC_SOLARIS) || defined(__i386__) ||                             \
    defined(__ARM_32BIT_STATE) // 32bit
#define IMAX 2050
#define JMAX 2050
#else // 64bit
#define IMAX 8194
...
extern long global_starttime;
extern long global_trackstart;
extern double global_psiai;
extern double global_psibi;
...
extern double global_err_multi;
extern long global_numspin;

extern pthread_mutex_t global_idlock;
extern pthread_mutex_t global_psiailock;
extern pthread_mutex_t global_psibilock;
extern pthread_mutex_t global_donelock;
extern pthread_mutex_t global_error_lock;
extern pthread_mutex_t global_bar_lock;
